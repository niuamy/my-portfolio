...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyMandatoryAttendeeIsConsidered() {
    // Have each mandatory person have different events with one optional person with an all day event. 
    // We should see three options because each mandatory person has split the restricted times, and the
    // optional person is ignored.
    //
    // Events  : |--------------C--------------|
    //                 |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyMandatoryAndOptionalAttendeeIsConsidered() {
    // Have each mandatory and option person have different events. 
  ...
  @Test
  public void justEnoughRoomIgnoringOptionalAttendee() {
    // Have one mandatory person and one optional person that has an availability smaller than the time slot.
    // Make it so the optional person is ignored, so that there is just enough room at one point in the day to
    // have the meeting.
    //                 |-B-|
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
  ...
  @Test
  public void onlyOptionalAttendeesNoGap() {
    // Have each optional person have different events. We should see no options because the events
    // are back to back.
    //
    // Events  : |------A------||------B-------|
    // Day     : |-----------------------------|
